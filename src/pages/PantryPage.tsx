...
const PantryPage = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      {/* Info Banner */}
      <div className="bg-brand-light/25 border border-brand/20 rounded-xl p-4 mb-7 flex items-start gap-3">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5 lg:gap-7">
        ...
        <div className="space-y-6">
          <div className="hela-card bg-gradient-to-br from-amber-50 to-orange-50 p-5 sm:p-6">
